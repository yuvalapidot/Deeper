...
//                    tables[j - 1] = table;
                    writer.dataTableToCsv(new DataTableToCsvRequest(klTable3, csvPath + experimentName + "\\" + "Regular\\" + experimentName + "-" + j + "-regular-kl-3" + csvName, CsvNumberRepresentation.INTEGER_REPRESENTATION, TRAIN_TEST, 100, 0.5));
                    writer.dataTableToCsv(new DataTableToCsvRequest(klTable5, csvPath + experimentName + "\\" + "Regular\\" + experimentName + "-" + j + "-regular-kl-5" + csvName, CsvNumberRepresentation.INTEGER_REPRESENTATION, TRAIN_TEST, 100, 0.5));
                    writer.dataTableToCsv(new DataTableToCsvRequest(entropyTable3, csvPath + experimentName + "\\" + "Regular\\" + experimentName + "-" + j + "-regular-entropy-3" + csvName, CsvNumberRepresentation.INTEGER_REPRESENTATION, TRAIN_TEST, 100, 0.5));
                    writer.dataTableToCsv(new DataTableToCsvRequest(entropyTable5, csvPath + experimentName + "\\" + "Regular\\" + experimentName + "-" + j + "-regular-entropy-5" + csvName, CsvNumberRepresentation.INTEGER_REPRESENTATION, TRAIN_TEST, 100, 0.5));
                    writer.dataTableToCsv(new DataTableToCsvRequest(cosineTable3, csvPath + experimentName + "\\" + "Regular\\" + experimentName + "-" + j + "-regular-cosine-3" + csvName, CsvNumberRepresentation.INTEGER_REPRESENTATION, TRAIN_TEST, 100, 0.5));
                    writer.dataTableToCsv(new DataTableToCsvRequest(cosineTable5, csvPath + experimentName + "\\" + "Regular\\" + experimentName + "-" + j + "-regular-cosine-5" + csvName, CsvNumberRepresentation.INTEGER_REPRESENTATION, TRAIN_TEST, 100, 0.5));
