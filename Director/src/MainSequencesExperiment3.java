...
public class MainSequencesExperiment3 {
    ...
    private static final String csvPath = "D:\\Dropbox\\NGrams\\Results\\Sequences\\Experiemnt 3\\";
    ...
    private static void discreteAndWrite(DataTable table, TD4CDiscretizator discretizator, int bins, String sign, String testedMalicious, String testedBenign) throws IOException {
        ...
        writer.dataTableToCsv(new DataTableToCsvRequest(discreteTable, csvPath + testedBenign + " & " + testedMalicious + " Tested\\min_support=" + minimumSupport + "-max_support=" + maximumSupport + "-sequence_length=" + minimumSequenceLength + "-" + maximumSequenceLength + "-" + sign + "-" + bins + "-bins.csv", CsvNumberRepresentation.INTEGER_REPRESENTATION, TRAIN_TEST, 100, 1));
    }
    ...
    private static void rankAndWrite(DataTable table, Ranker ranker, String testedMalicious, String testedBenign) throws IOException {
        ...
        writer.dataTableToCsv(new DataTableToCsvRequest(rankedTable, csvPath + testedBenign + " & " + testedMalicious + " Tested\\min_support=" + minimumSupport + "-max_support=" + maximumSupport + "-sequence_length=" + minimumSequenceLength + "-" + maximumSequenceLength + "-ranked.csv", CsvNumberRepresentation.INTEGER_REPRESENTATION, TRAIN_TEST, 100, 1));
    }
