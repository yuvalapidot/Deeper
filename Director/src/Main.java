...
//            writer.dataTableToCsv(new DataTableToCsvRequest(table, csvPath + " " + (i + 1) + "\\" + "Regular\\" + j + "-regular-train" + csvName, CsvNumberRepresentation.INTEGER_REPRESENTATION, TRAIN, 100, 0));
//            writer.dataTableToCsv(new DataTableToCsvRequest(table, csvPath + " " + (i + 1) + "\\" + "Regular\\" + j + "-regular-test" + csvName, CsvNumberRepresentation.INTEGER_REPRESENTATION, TEST, 100, 0));
...
//            writer.dataTableToCsv(new DataTableToCsvRequest(table, csvPath + " " + (i + 1) + "\\" + "Binary\\" + j + "-binary-train" + csvName, CsvNumberRepresentation.BINARY_REPRESENTATION, TRAIN, 100, 0));
//            writer.dataTableToCsv(new DataTableToCsvRequest(table, csvPath + " " + (i + 1) + "\\" + "Binary\\" + j + "-binary-test" + csvName, CsvNumberRepresentation.BINARY_REPRESENTATION, TEST, 100, 0));
...
//            writer.dataTableToCsv(new DataTableToCsvRequest(table, csvPath + " " + (i + 1) + "\\" + "TF\\" + j + "-tf-train" + csvName, CsvNumberRepresentation.TF_REPRESENTATION, TRAIN, 100, 0));
//            writer.dataTableToCsv(new DataTableToCsvRequest(table, csvPath + " " + (i + 1) + "\\" + "TF\\" + j + "-tf-test" + csvName, CsvNumberRepresentation.TF_REPRESENTATION, TEST, 100, 0));
...
//            writer.dataTableToCsv(new DataTableToCsvRequest(table, csvPath + " " + (i + 1) + "\\" + "TF-IDF\\" + j + "-tf-idf-train" + csvName, CsvNumberRepresentation.TFIDF_REPRESENTATION, TRAIN, 100, 0));
//            writer.dataTableToCsv(new DataTableToCsvRequest(table, csvPath + " " + (i + 1) + "\\" + "TF-IDF\\" + j + "-tf-idf-test" + csvName, CsvNumberRepresentation.TFIDF_REPRESENTATION, TEST, 100, 0));
